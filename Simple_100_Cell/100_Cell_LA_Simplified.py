...
# Number of A - 40, B - 24, C - 16, Total - 80
...
netParams.stimTargetParams['bkg->pyr_a'] = {'source': 'bg2pyr_stim', 'conds': {'popLabel': 'PN_A'}, 'loc': 0.9, 'delay': 1, 'weight': 2, 'synMech': 'bg2pyr'}
netParams.stimTargetParams['bkg->pyr_b'] = {'source': 'bg2pyr_stim', 'conds': {'popLabel': 'PN_B'}, 'loc': 0.9, 'delay': 1, 'weight': 1.55, 'synMech': 'bg2pyr'}
netParams.stimTargetParams['bkg->pyr_c'] = {'source': 'bg2pyr_stim', 'conds': {'popLabel': 'PN_C'}, 'loc': 0.9, 'delay': 1, 'weight': 1.5, 'synMech': 'bg2pyr'}
